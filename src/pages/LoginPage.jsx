...
function LoginPage() {
  ...
  const { login, register, signInWithGoogle, signInWithGithub } = useAuth()

  useEffect(() => {
    if (location.state?.showSignup === true) {
      setIsLogin(false)
      ...
      <div className="login-container">
        <div className="login-card">
          <div className="login-header">
            <h2>{isLogin ? 'Welcome Back' : 'Create Your Free Account'}</h2>
            <p className="login-subtitle">
              {isLogin ? 'Sign in to continue debugging' : 'Join our debugging community for free'}
            </p>
          </div>
